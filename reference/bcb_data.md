...
#> Error in resp_body_json(req_perform(req_error(req_url_query(req_url_path_append(base_request("https://api.bcb.gov.br/dados/serie"),     sprintf("bcdata.sgs.%s", series), "dados"), formato = "json",     ...), body = bcb_error_body))): Unexpected content type "text/html".
