test_that("nbp_fx_rates input validation works", {
  ...
  expect_error(nbp_fx_rates("a", end_date = "2025-01-01"), "must be given together")
  expect_error(nbp_fx_rates("a", start_date = "2025-01-01"), "must be given together")
})
...
test_that("nbp_gold input validation works", {
  ...
  expect_error(nbp_gold(end_date = "2025-01-01"), "must be given together")
  expect_error(nbp_gold(start_date = "2025-01-01"), "must be given together")
})
