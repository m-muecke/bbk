...
- [Bank of Japan (BoJ)](https://www.stat-search.boj.or.jp/ssi/html/nme_a_en.html)
...
`bdp_`, `bis_`, `boe_`, `boj_`, `bde_`, `bdf_`, `nbp_`, `onb_`, `boc_`, `nob_`, `srb_`) and follow the naming conventions of their respective APIs.
